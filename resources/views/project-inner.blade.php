...
@section('meta')
  ...
  <meta property="og:image" content="{{env('APP_URL') . '/storage/' . data_get($project, 'seo_settings.image')}}">
  @else
  <meta property="og:image" content="{{env('APP_URL') . '/storage/' . data_get($project, 'cover_image.url')}}">
  @endif
