...
@section('meta')
    @if (App::getLocale() === 'en')
      <title> {{data_get($news, 'seo_settings.meta_title', data_get($news, 'title.main') )}} | {{data_get($page, 'settings.seo.title_en')}} </title>
    @else
      <title>{{data_get($news, 'seo_settings.meta_title', data_get($news, 'title.main'))}} | {{data_get($page, 'settings.seo.title_ge')}} </title>
    @endif

  <meta name="title" property="title" content="{{data_get($news, 'seo_settings.meta_title', data_get($news, 'title.main'))}}"/>
  ...
  <meta property="og:title" content="{{data_get($news, 'seo_settings.og_title', data_get($news, 'title.main'))}}">
