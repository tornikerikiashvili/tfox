        ...
        <div class="flex-container response-999 top-padding-60">
            @foreach ($projects as $project)
                ...
                <div class="four-columns bottom-padding-60">
                    <a data-animation-container href="{{App::getLocale() . '/project/' . data_get($project, 'metadata.slug')}}" class="animsition-link content-right-margin-20 hover-box pointer-large d-block light-bg-2">
