            ...
            <div class="portfolio-content-inner flex-min-height-inner">
                ...
                <div class="flex-container container small">
                    ...
                    <div id="selector1" class="six-columns top-padding-60">
                        <a href="{{App::getLocale() . '/project/' . data_get($project, 'slug')}}" class="animsition-link  portfolio-content-bg-box pointer-large hover-box hidden-box">
            ...
            <div class="portfolio-content-inner flex-min-height-inner">
                ...
                <div class="flex-container reverse container small">
                    ...
                    <div class="six-columns top-padding-60">
                        <a href="{{App::getLocale() . '/project/' . data_get($project, 'slug')}}" class="portfolio-content-bg-box pointer-large hover-box hidden-box animsition-link">
