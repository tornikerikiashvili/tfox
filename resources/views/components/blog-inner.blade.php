        ...
        <!-- column start -->
					<div class="eight-columns">
						...
						<div class="light-bg-2">
							<a class="photo-popup pointer-zoom" href="{{'/storage/' . data_get($blog, 'cover_image')}}">
								<img src="{{'/storage/' . data_get($blog, 'cover_image')}}" alt="title">
							</a>
							<!-- content-margin-block start -->
							<div class="content-margin-block">
                                <h3 class="main_news_title text-color-1 top-margin-30 blog-title">
                                    <span class="hover-content" >{{data_get($blog, 'title')}}</span>
                                </h3>
								<!-- entry-content start -->
                                    <blog class="entry-content">
                                        {!!data_get($blog, 'content')!!}
                                    </blog>
                                <!-- entry-content end -->

                                	<!-- post-img-flex start -->
									<div class="post-img-flex">
                                        @foreach (data_get($blog, 'inner_cover_image') as $img)
								...
								<div class="post-share">
									...
									<ul class="post-share-social text-color-1">
										...
										<li><a  onclick="window.open('https://linkedin.com/shareblog?url=' + encodeURIComponent(document.URL), '', '_blank, width=500, height=500, resizable=yes, scrollbars=yes'); return false;" class="pointer-small hover-color" href="#"><i class="fab fa-linkedin-in"></i></a></li>
									</ul>
								</div><!-- post-share end -->
                                ...
                                <!-- recent-entry start -->
                                    <div class="recent-entry">
                                        ...
                                        <div class="recent-desc">
                                            <a href="{{App::getLocale() . '/blog/' . data_get($item, 'metadata.slug')}}" class="xsmall-title-oswald text-color-4 pointer-large animsition-link">{{data_get($item, 'title')}}</a>
